#   File for random forest classifier   classes - positive and negative
...
#.........................  Reading files and removing stopwords and 
fp= open('test3r.txt','w')
...
#Doing classification using random forest classifier with 50 trees
clf =  RandomForestClassifier(n_estimators=50)
model=clf.fit(feature_matrix, output_matrix)
import pickle
f = open('randomforest_train.pkl','wb')
pickle.dump(clf,f)
f.close
'''
